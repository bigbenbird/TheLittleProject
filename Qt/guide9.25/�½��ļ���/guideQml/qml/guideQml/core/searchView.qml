...
Rectangle
{
    ...
    Rectangle{
        ...
        Text
        {
            ...
            font.pointSize:10
            id:startDetail
            text: "(enter the number of the room which you are in)"
        }
        Rectangle{
    ...
    Rectangle{
        ...
        Text
        {
            ...
            font.pixelSize: 13
            text:"(enter the number of the room which you want to go)"
        }
        Rectangle{
            id:endEditRectangle
            anchors.verticalCenter: parent.verticalCenter
    ...
    Rectangle{
        ...
        Button
        {
            ...
            onButtonClick:search(startEdit.text,endEdit.text)
        }
        Button
        {
            id:returnButton
